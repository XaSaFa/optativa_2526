...
class Joc:
    ...
    def __init__(self, ample, alt, fps, nombre_meteors):
        ...
        self.nau = Nau('assets/nave1.png', velocitat=5, pos_x=300, pos_y=450,
    ...
    def mostrar_pantalla_inici(self):
        ...
        self._dibuixar_text("METEORITS", mida=64, color=(255, 255, 255),
                             x=self.ample // 2, y=160, centrat=True)
        self._dibuixar_text("Prem ESPAI per començar", mida=28, color=(200, 200, 200),
                             x=self.ample // 2, y=280, centrat=True)
        self._dibuixar_text("Mou la nau amb les fletxes o WASD", mida=22,
                             color=(180, 180, 180), x=self.ample // 2, y=330, centrat=True)
    ...
    def preparar_partida(self):
        ...
        for i in range(self.numero_meteors):
            meteor_nou = Meteor('assets/meteor.png', velocitat=0, pos_x=0, pos_y=0)

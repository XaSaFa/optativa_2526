...
- Dificultat progresiva en la velocitat o número de meteorits.
- Poder disparar als metorits. Quan es dispara hi ha un efecte de so i si impacta una bala amb un meteor un altre efecte de so diferent (desapareix la bala i el meteor i sumem més punts).

**Entregar el vostre projecte com link a un fitxer comprimit del drive.**
